...
const heroImages = [
  '/mall_images/ptm_hero.webp',
  '/mall_images/IMG_1360.webp',
  '/mall_images/IMG_1361.webp',
  '/mall_images/IMG_1362.webp',
  '/mall_images/IMG_1363.webp',
  '/mall_images/IMG_1364.webp',
  '/mall_images/IMG_1365.webp',
  '/mall_images/IMG_1366.webp',
  '/mall_images/IMG_1368.webp',
];
...
const HeaderSection = () => {
  ...
  return (
    <header ref={containerRef} className="relative w-full" style={{ fontFamily: "'Arizona Flare', 'Times New Roman', serif" }}>
      {/* Hero Section */}
      <div className="relative h-screen w-full overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-black/75 via-black/85 to-black/99 z-10" />

        {/* Hero Text */}
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-center w-full max-w-4xl px-4 z-20">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-white tracking-widest drop-shadow-[0_4px_12px_rgba(0,0,0,0.8)] uppercase leading-tight" style={{ fontFamily: "'Arizona Flare', 'Times New Roman', serif" }}>
            ELEVATE YOUR SHOPPING EXPERIENCE
          </h1>

          <div className="mt-6 flex flex-col items-center">
            <div className="w-16 h-[1px] bg-gradient-to-r from-transparent via-red-400/60 to-transparent mb-4" />
            <p className="text-sm md:text-lg font-light text-gray-100 tracking-wider" style={{ fontFamily: "'Lora', 'Playfair Display', serif" }}>
              Your all-in-one stop for fashion, food, and everyday finds.
            </p>
          </div>
        </div>
        ...
        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-30 flex items-center space-x-2.5">
          {heroImages.map((_, index) => (
            <button
              ...
              className={`h-2 rounded-full transition-all duration-500 cursor-pointer ${index === currentImageIndex ? 'w-8 bg-white shadow-lg' : 'w-2 bg-white/40 hover:bg-white/70'
                }`}
